...
export default class LogoIcon extends BaseSvg {
  render() {
    const props = this.getSVGProps();

    return (
      <LogoContainer width="32px" height="32px" viewBox="24 8 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" {...props}>
        <defs>
